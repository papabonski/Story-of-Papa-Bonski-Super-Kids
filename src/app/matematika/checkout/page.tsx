    ...
    <main className="min-h-[100dvh] bg-[#f5eee3] px-5 py-8 text-ink">
      <div className="mx-auto max-w-lg">
        <div className="mb-5 flex items-center justify-between gap-4">
          <Link href="/matematika/beli" className="flex items-center gap-2 font-extrabold">
          ...
          <Link href="/matematika/beli" className="text-sm font-bold text-ink-soft">Kembali</Link>
        </div>
        ...
        <div className="rounded-[2rem] bg-white p-6 shadow-xl ring-1 ring-black/[0.06] sm:p-8">
          ...
          <p className="mt-3 text-sm leading-relaxed text-ink-soft">
            Pelanggan baru mendapat akses seumur hidup seharga <b>Rp25.000</b>. Pemilik aktif Papa Bonski Super Kids atau Mandarin mendapat harga add-on <b>Rp15.000</b>.
          </p>
